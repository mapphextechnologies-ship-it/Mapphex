(() => {
  ...
  const rolePermissions = {
    ...
    "hr-staff": ["hr.manage", "reports.read", "payroll.prepare", "employees.manage"],
    ...
    logistics: ["logistics.manage", "driver.manage", "reports.read"],
    "logistics-staff": ["logistics.manage", "driver.manage", "reports.read"],
    driver: ["driver.read", "logistics.read"],
